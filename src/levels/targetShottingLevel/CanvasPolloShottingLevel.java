 ...
 * @author theowl
 */
public class CanvasPolloShottingLevel implements GLEventListener, MouseListener, MouseMotionListener, KeyListener{
    int[] ban;
    int con;
    ...
    public CanvasPolloShottingLevel(JFrame frame) {
        this.frame = frame;
    ...
    public void init(GLAutoDrawable drawable)
    {
        ...
        pollo = new DrawPollito(gl, glu, ban, con,frame);
        pollo.movingForward = true;
        pollo.movingForward1 = true;
        pollo.movingForward2 = true;
        // Enable VSync
    ...
    public void display(GLAutoDrawable drawable)
    {
        ...
        gl.glPushMatrix();
        pollo.draw(gl,glu,keys['A'], keys['D'], keys['W']);
        gl.glPopMatrix();
